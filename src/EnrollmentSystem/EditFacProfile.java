...
public class EditFacProfile extends javax.swing.JFrame {
    ...
    public EditFacProfile() {
        ...
        facIdLabel.setText((String) Login.ID.get(Login.logmark));
        fullNameLabel.setText((String) Login.name.get(Login.logmark));
        String tempPass ="";
        int len = Login.password.get(Login.logmark).toString().length();
        for(int f=0; f<len; f++)
        {
            tempPass+="•";
        }
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
       ...
       idField.setText((String)Login.ID.get(Login.logmark));
       firstNameField.setText((String)Login.Fname.get(Login.logmark));
       lastNameField.setText((String)Login.Lname.get(Login.logmark));
       middleNameField.setText((String)Login.Mname.get(Login.logmark));
       facPassField.setText((String)Login.password.get(Login.logmark));
        ...
        else
        {
              int ctr=0;
                for(int x=0;x<Login.ID.size();x++)
                {
                    ...
                    {
                    if(idField.getText().equals(Login.ID.get(x)))
                    ctr=1;
                    }
                }
...
//                {
            ...
            if(firstName.contains(" "))
        {
            ...
            Login.name.set(Login.logmark, lastName+", "+firstName+", "+middleName);
            Login.Fname.set(Login.logmark, firstName);
            Login.Lname.set(Login.logmark, lastName);
            Login.Mname.set(Login.logmark, middleName);
            Login.password.set(Login.logmark, facPassField.getText().toString());
            Login.ID.set(Login.logmark,idField.getText().toString());
            Main.facNumLabel.setText((String) Login.ID.get(Login.logmark));
            idField.setVisible(false);
            firstNameField.setVisible(false);
            lastNameField.setVisible(false);
            middleNameField.setVisible(false);
